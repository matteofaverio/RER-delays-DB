...
%  University DBMS Course — April 2026
%
%  Author assignments:
%    [M] = Matteo   [N] = N   [L] = L
%
%  Placeholder commands:
%    \placeholder{text}   — grey box for content still to be added
%    \todoM{note}         — red  sticky note for Matteo
%    \todoN{note}         — blue sticky note for N  (remove before submission)
%    \todoL{note}         — green sticky note for L (remove before submission)
%
%  Compile with: pdflatex report_skeleton.tex  (twice, for TOC and \ref)
% =============================================================================
